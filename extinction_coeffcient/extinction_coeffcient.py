...
Description  : Copyright© Zhang,Ruoyi. ALL RIGHTS RESERVED.

'''

def extinction_coeffcient(Band,EBV=None,BP_RP=None,Teff=None,mode='func'):
    """
    ...
    if mode=='simple': # If only ask for single-value R
        ...
        if Teff != None : # calculate R(EBV,Teff)
        ...
        elif BP_RP != None: # calculate R(EBV,BPRP0)
